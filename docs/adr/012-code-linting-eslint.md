...
4. **Інтеграція з frameworks**
    - NestJS — рекомендований конфіг-файл
    - Next. js — вбудований `eslint-config-next`

5. **Автовиправлення**
    - Багато правил для автоматичного виправлення помилок
...
- ❌ Менше плагінів
- ❌ Менше підтримки в IDE
- ✅ Швидший (Rust-based)
- ✅ Лінтер + форматер (але ми вже обрали Prettier)
...
Уже включено в ADR-011, але додамо:
...
- Команда повинна дотримуватися правил
