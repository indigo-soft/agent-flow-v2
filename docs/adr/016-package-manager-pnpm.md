...
- ❌ Повільніший за pnpm
- ❌ Менш ефективне використання диску
...
- ✅ Менше використання диску (важливо для CI runners)
...
- **v9** — beta/experimental (нові features але може бути нестабільна)
